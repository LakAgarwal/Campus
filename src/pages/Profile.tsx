...
const ProfilePage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    async function getProfile() {
      try {
        setLoading(true);
        const res = await apiFetch<Profile & Record<string, unknown>>(`/profiles/auth/${userId}`);
    ...
    async function fetchEvents() {
      ...
      try {
        ...
        if (res.data && Array.isArray(res.data)) {
          const sortedEvents = sortEventsByPreference(res.data as unknown as Event[], preferences);
